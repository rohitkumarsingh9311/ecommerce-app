...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
       <Link to='/'> <img src={assets.logo} alt="logo forever" className="w-36" /></Link>
        ...
        <div className="flex items-center gap-6">
            ...
            <Link to='/cart' className="relative">
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspact-square rounded-full text-[12px]'>{getCartCount()}</p>
            </Link>
            <img onClick={()=>{setVisible(true)}}src={assets.menu_icon} className="w-10 cusrsor-pointer sm:hidden" />
        </div>
